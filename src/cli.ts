...
function formatResultSets(resultSets: Array<{ index: number; columns: Array<{ index: number; name: string; type: string; nullable?: boolean; source?: string; note?: string }> }>): string {
...
function formatTable(columns: Array<{ index: number; name: string; type: string; nullable?: boolean; source?: string; note?: string }>): string {
