...
export const dialectConfig = {
  ...
  metadata: {
    ...
    snowflakeDescribeObjectColumns: {
      alert: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      warehouse: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }, { name: 'default', type: 'text' }, { name: 'level', type: 'text' }, { name: 'description', type: 'text' }],
      integration: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      stage: [{ name: 'parent_property', type: 'text' }, { name: 'property', type: 'text' }, { name: 'property_type', type: 'text' }, { name: 'property_value', type: 'text' }, { name: 'property_default', type: 'text' }],
      pipe: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      stream: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      task: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      role: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      user: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      database: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
      share: [{ name: 'property', type: 'text' }, { name: 'value', type: 'text' }],
    },
