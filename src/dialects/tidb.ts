...
export const dialectConfig = {
  ...
  metadata: {
    ...
    explainColumns: [
      { name: "id", type: "text" },
      { name: "estRows", type: "text" },
      { name: "task", type: "text" },
      { name: "access object", type: "text" },
      { name: "operator info", type: "text" },
    ],
    ...
    commandResultColumns: [
      {
        pattern: "/^show\\s+stats_meta$/i",
        columns: [
          { name: "Db_name", type: "text" },
          { name: "Table_name", type: "text" },
          { name: "Partition_name", type: "text" },
          { name: "Update_time", type: "timestamp" },
          { name: "Modify_count", type: "bigint" },
          { name: "Row_count", type: "bigint" },
          { name: "Last_analyze_time", type: "timestamp" },
        ],
      },
      {
        pattern: "/^show\\s+stats_histograms$/i",
        columns: [
          { name: "Db_name", type: "text" },
          { name: "Table_name", type: "text" },
          { name: "Partition_name", type: "text" },
          ...
          { name: "Avg_col_size", type: "decimal" },
          { name: "Correlation", type: "decimal" },
          { name: "Load_status", type: "text" },
          { name: "Total_mem_usage", type: "bigint" },
          { name: "Hist_mem_usage", type: "bigint" },
          { name: "Topn_mem_usage", type: "bigint" },
          { name: "Cms_mem_usage", type: "bigint" },
        ],
      },
      {
        pattern: "/^show\\s+table\\s+regions$/i",
        columns: [
          { name: "REGION_ID", type: "bigint" },
          { name: "START_KEY", type: "text" },
          { name: "END_KEY", type: "text" },
          { name: "LEADER_ID", type: "bigint" },
          { name: "LEADER_STORE_ID", type: "bigint" },
          { name: "PEERS", type: "text" },
          { name: "SCATTERING", type: "boolean" },
          { name: "WRITTEN_BYTES", type: "bigint" },
          { name: "READ_BYTES", type: "bigint" },
          { name: "APPROXIMATE_SIZE(MB)", type: "bigint" },
          { name: "APPROXIMATE_KEYS", type: "bigint" },
          { name: "SCHEDULING_CONSTRAINTS", type: "text" },
          { name: "SCHEDULING_STATE", type: "text" },
        ],
      },
      {
        pattern: "/^show\\s+table\\s+regions\\s+from\\s+\\S+$/i",
        columns: [
          { name: "REGION_ID", type: "bigint" },
          { name: "START_KEY", type: "text" },
          { name: "END_KEY", type: "text" },
      ...
      {
        pattern: "/^show\\s+table\\s+\\S+\\s+regions$/i",
        columns: [
          { name: "REGION_ID", type: "bigint" },
          { name: "START_KEY", type: "text" },
          { name: "END_KEY", type: "text" },
