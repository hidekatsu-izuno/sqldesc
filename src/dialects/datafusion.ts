    ...
    builtinSchemaTables: [
      {
        ...
        columns: [
          ...
          { name: "character_maximum_length", type: "bigint" },
          { name: "character_octet_length", type: "bigint" },
          { name: "numeric_precision", type: "bigint" },
          { name: "numeric_precision_radix", type: "bigint" },
          { name: "numeric_scale", type: "bigint" },
          { name: "datetime_precision", type: "bigint" },
      ...
      },
      {
        ...
        columns: [
          ...
          { name: "is_deterministic", type: "boolean" },
          { name: "data_type", type: "text" },
          { name: "function_type", type: "text" },
          { name: "description", type: "text" },
          { name: "syntax_example", type: "text" },
        ],
      },
      {
        schema: "information_schema",
