...
| name | type | source |
|------|------|--------|
| age_text | varchar2(255) | polyglot |
...
| name | varchar2(255) | json_table.name |
...
| name | type | source |
|------|------|--------|
| full_name | varchar2(255) | t.full_name |
